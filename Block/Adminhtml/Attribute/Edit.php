...
namespace Smile\ElasticsuiteCustomEntity\Block\Adminhtml\Attribute;

/**
 * Custom entity attribute edit block.
 *
 * @category Smile
 * @package  Smile\ElasticsuiteCustomEntity
 * @author   Aurelien FOUCRET <aurelien.foucret@smile.fr>
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
     ...
     * @var string
     */
    protected $_blockGroup = 'Smile_ElasticsuiteCustomEntity';
