...
class CustomEntity extends \Smile\ScopedEav\Model\AbstractEntity implements IdentityInterface, CustomEntityInterface
{
     ...
     * @var string
     */
    protected $_eventPrefix = 'smile_elasticsuite_custom_entity';

    /**
     * @var string
     */
    protected $_eventObject = 'smile_elasticsuite_custom_entity';
     ...
     * {@inheritdoc}
     *
     * @return \Smile\ElasticsuiteCustomEntity\Api\Data\CustomEntityExtensionInterface $extensionAttributes\null
     */
     ...
     * {@inheritdoc}
     *
     * @param \Smile\ElasticsuiteCustomEntity\Api\Data\CustomEntityExtensionInterface $extensionAttributes
     *
     * @return $this
     */
    public function setExtensionAttributes(\Smile\ElasticsuiteCustomEntity\Api\Data\CustomEntityExtensionInterface $extensionAttributes)
    {
    ...
    {
        $this->_init(\Smile\ElasticsuiteCustomEntity\Model\ResourceModel\CustomEntity::class);
    }
