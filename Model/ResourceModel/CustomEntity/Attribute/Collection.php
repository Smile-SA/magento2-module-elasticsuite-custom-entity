...
namespace Smile\ElasticsuiteCustomEntity\Model\ResourceModel\CustomEntity\Attribute;
...
class Collection extends \Magento\Eav\Model\ResourceModel\Entity\Attribute\Collection
{
    ...
    {
        $this->_init(
            \Smile\ElasticsuiteCustomEntity\Model\CustomEntity\Attribute::class,
    ...
    protected function _initSelect()
    {
        $entityTypeId = $this->eavConfig->getEntityType(
            \Smile\ElasticsuiteCustomEntity\Model\CustomEntity\Attribute::ENTITY_TYPE_CODE
        )->getEntityTypeId();
