...
namespace Smile\ElasticsuiteCustomEntity\Model\ResourceModel;
...
class CustomEntity extends \Smile\ScopedEav\Model\ResourceModel\AbstractResource
{
    ...
    {
        if (empty($this->_type)) {
            $this->setType(\Smile\ElasticsuiteCustomEntity\Model\CustomEntity::ENTITY);
        }
    ...
    public function getCustomEntityWebsiteTable()
    {
        if (!$this->customEntityWebsiteTable) {
            $this->customEntityWebsiteTable = $this->getTable('smile_elasticsuite_custom_entity_website');
        }
    ...
    public function getWebsiteIds($entity)
    {
        ...
        if ($entity instanceof \Smile\ElasticsuiteCustomEntity\Model\CustomEntity) {
