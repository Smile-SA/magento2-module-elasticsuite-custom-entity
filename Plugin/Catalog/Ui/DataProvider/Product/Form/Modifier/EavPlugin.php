...
namespace Smile\ElasticsuiteCustomEntity\Plugin\Catalog\Ui\DataProvider\Product\Form\Modifier;

use Smile\ElasticsuiteCustomEntity\Model\ResourceModel\CustomEntity\CollectionFactory as EntityCollectionFactory;
...
class EavPlugin
{
    ...
    private function getOptions(ProductAttributeInterface $attribute)
    {
        ...
        /**
         * @var \Smile\ElasticsuiteCustomEntity\Model\ResourceModel\CustomEntity\Collection $collection
         */
